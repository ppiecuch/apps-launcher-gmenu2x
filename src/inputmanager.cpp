...
const uint32_t sdl_map_btn_usb[SDL_MAP_SIZE] = { DC_BTN_Y, DC_BTN_B, DC_BTN_A, DC_BTN_X, 0, 0, 0, 0, 0, DC_BTN_START };
const uint32_t sdl_map_axis_usb[SDL_MAP_SIZE] = { DC_AXIS_X, DC_AXIS_Y, 0, 0, 0, 0, 0, 0, 0, 0 };
const uint32_t sdl_map_btn_xbox360[SDL_MAP_SIZE] = { DC_BTN_A, DC_BTN_B, DC_BTN_X, DC_BTN_Y, 0, 0, 0, DC_BTN_START, 0, 0 };
const uint32_t sdl_map_axis_xbox360[SDL_MAP_SIZE] = { DC_AXIS_X, DC_AXIS_Y, DC_AXIS_LT, 0, 0, DC_AXIS_RT, DC_DPAD_LEFT, DC_DPAD_UP, 0, 0 };

const uint32_t* sdl_map_btn  = sdl_map_btn_usb;
const uint32_t* sdl_map_axis = sdl_map_axis_usb;
